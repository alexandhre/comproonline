        ...
        <section class="section">
            <div class="container has-text-left">
                ...
                <div class="columns">
                                ...
                                <div class="media-content">
                                    <div class="media-left">
                                        <figure class="image" v-for="item in images.slice(0, 1)">
                                            <img class="image is-2by3" id="imgP" style="height: auto;width: auto;margin-left: auto;"
                                                 :src="item" onerror="this.onerror=null; this.src='/eucomproonline/images/photo.png';" alt="">
                                        </figure>
                                    </div>
                                </div>
                    ...
                    <div class="column is-5" style="padding-left: 120px">
                        <article class="media">
                            <div class="media-left">
                        ...
                        <div class="media-content">
                            ...
                            <p class="subtitle is-6 has-text-left is-bold" style="color: #23A7FB">R$ {{this.anuncio.VL_TIPO_ANUNCIO}}</p>
                        </div>
                        <br><br>
                        <p class="control">
...
<script>
    ...
    export default {
        ...
        mounted() {
                this.anuncio = this.anuncio['0'];
                for (var i = 0; i < this.anuncio.foto.length; i++) {
                    this.images.push('/eucomproonline/images/anuncios/'+ this.anuncio.ID_ANUNCIO_PRODUTO+'/'+this.anuncio.foto[i].foto);
                }
            ...
            axios.get('/eucomproonline/anuncio/outros/produtos/' + this.anuncio.ID_ANUNCIO_PRODUTO).then(resp =>{
