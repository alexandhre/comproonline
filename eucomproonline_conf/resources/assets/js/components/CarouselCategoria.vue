                    ...
                    <div class="card-carousel--overflow-container">
                        <div class="card-carousel-cards" :style="{ transform: 'translateX' + '(' + currentOffset + 'px' + ')'}">
                            <div class="column" v-for="item in categorias">
                                <div class="card" style="height: 100%; cursor: pointer"  v-on:click="catTipo(item.DS_CATEGORIA_PRODUTO)">
                                    <div class="card-image">
                                        <figure class="image is-1by1">
                                            <img :src="'/eucomproonline/css/img/categorias/' + item.DS_FOTO_CATEGORIA_PRODUTO" style="height: auto;width: auto;max-width: 100%;max-height: 100%;margin: auto;">
                                        </figure>
                                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            catTipo(id){
                ...
                window.open("/eucomproonline/categoria/tipo/"+id,'_self');
            },
        }
    }
</script>
