                                    ...
                                    <div class="upload-image is-pulled-left  " >
                                        <label for="file" class="label-file-img" >
                                            ...
                                            <a id="close1" class="button-close close" name="uploadImage"
                                               style="display:none; position: static; margin-top: -110px;margin-left: 110px;" v-on:click="remover(1)"><i class="fa fa-times-circle fa-2x"
                                                                        aria-hidden="true"></i></a>
                                            <a id="open1" class="button-open open" name="uploadImage"  style="position: static; margin-top: -20px; margin-left: 110px;"
                                    ...
                                    <div class="upload-image is-pulled-left " >
                                        <label for="file2" class="label-file-img">
                                            ...
                                            <a id="close2" class="button-close close" name="uploadImage"
                                               style="display:none; position: static; margin-top: -110px;margin-left: 110px;" v-on:click="remover(2)"><i class="fa fa-times-circle fa-2x"
                                                                        aria-hidden="true"></i></a>
                                    ...
                                    <div class="upload-image is-pulled-left " >
                                        <label for="file3" class="label-file-img" >
                                            ...
                                            <a id="close3" class="button-close close" name="uploadImage"
                                               style="display:none; position: static; margin-top: -110px;margin-left: 110px;" v-on:click="remover(3)"><i class="fa fa-times-circle fa-2x"
                                                                        aria-hidden="true"></i></a>
                                    ...
                                    <div class="upload-image is-pulled-left " >
                                        <label for="file4" class="label-file-img">
                                            ...
                                            <a id="close4" class="button-close close" name="uploadImage"
                                               style="display:none; position: static; margin-top: -110px;margin-left: 110px;" v-on:click="remover(4)"><i class="fa fa-times-circle fa-2x"
                                                                        aria-hidden="true"></i></a>
                                    ...
                                    <div class="upload-image is-pulled-left "  >
                                        <label for="file5" class="label-file-img">
                                            ...
                                            <a id="close5" class="button-close close" name="uploadImage"
                                               style="display:none; position: static; margin-top: -110px;margin-left: 110px;" v-on:click="remover(5)"><i class="fa fa-times-circle fa-2x"
                                                                        aria-hidden="true"></i></a>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            axios.get('/eucomproonline/anuncio/editar/'+   this.id).then((response)=>{

                //console.log(response.data['0']);
                console.log(response.data['0']);
                $('#titulo').val(response.data['0'].DS_ANUNCIO_PRODUTO);
                $('#descricao').val(response.data['0'].DS_DETALHE_PRODUTO);
                $('#preco').val(response.data['0'].VL_TIPO_ANUNCIO);
                // $('#categoria').val("resre");
                this.cat = response.data['0'].DS_CATEGORIA_PRODUTO;
                this.prod = response.data['0'].DS_TIPO_PRODUTO;
                //fotos do anuncio
                for(var j = 1; j <= response.data['0'].foto.length; j++){

                    $('#filename'+j).removeClass("bad-input");
                    $('#close'+j).css('display', 'block');
                    $('#open'+j).css('display', 'none');
                    $('#uploadicon'+j).css('display', 'none');
                    $('#imagem'+j).css('display', 'block');
                    $('#imagem'+j).attr('src','http://eucompro.online/eucomproonline/images/anuncios/'+this.id+'/'+response.data['0'].foto[j-1].foto);
                    this.foto.push(response.data['0'].foto[j-1].foto);
                }
        ...
        methods:{
            ...
            onFileChanged1: function (event) {
                ...
                if (this.selectedFile1 !== null) {
                    ...
                    axios.post('/eucomproonline/anuncio/foto', formData).then(res=>{
                        this.foto['0'] = res.data;
                    });
                } else {
            ...
            remover(id) {
                var foto;
                    foto = this.foto[id];  
                    this.foto.splice((id-1), 1); 
                    $('#filename'+id).removeClass("bad-input");
                    $('#close'+id).css('display', 'none');
                    $('#open'+id).css('display', 'block');
                    $('#uploadicon'+id).css('display', 'block');
                    $('#imagem'+id).css('display', 'none');
                    $('#imagem'+id).attr('src', '');
            ...
            concluir() {
                ...
                axios.post('/eucomproonline/anuncio/editar', {
                    input: this.input
                    ...
                    .then(response => {
                        if(response.data === 0){
                            ...
                            window.open("/eucomproonline/anuncio/meus/produtos/page",'_Self');
                        }else{
